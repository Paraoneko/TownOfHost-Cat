    ...
    public static class UtilsShowOption
    {
        ...
        public static void ShowWinSetting(byte PlayerId = byte.MaxValue, bool IsMonochrome = false)
        {
            ...
            foreach (var date in SoloWinOption.AllData)
            {
                ...
                (date.Key is CustomRoles.Jackal) && (CustomRoles.JackalAlien.IsEnable() || CustomRoles.JackalMafia.IsEnable() || CustomRoles.JackalWolf.IsEnable() || CustomRoles.JackalHadouHo.IsEnable()))
                {
