    ...
    class GameSettingMenuStartPatch
    {
        ...
        public static void Postfix(GameSettingMenu __instance)
        {
            ...
            try
            {
                ...
                ModSettingsButton.buttonText.text = "TownOfHost-Cat";
                ...
                for (var i = 0; i < TabLength; i++)
                {
                    ...
                    tabButton.inactiveSprites.GetComponent<SpriteRenderer>().sprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Tab.TabIcon_{tab}.png", 60);
                    tabButton.activeSprites.GetComponent<SpriteRenderer>().sprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Tab.TabIcon_S_{tab}.png", 120);
                    tabButton.selectedSprites.GetComponent<SpriteRenderer>().sprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Tab.TabIcon_{tab}.png", 120);
                ...
                for (var i = 0; i < TabLength; i++)
                {
                    ...
                    tabButton.OnClick.AddListener((Action)(() =>
                    {
                        for (var i = 0; i < TabLength; i++)
                        {
                            ...
                            tabButton.selectedSprites.GetComponent<SpriteRenderer>().sprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Tab.TabIcon_{n}.png", 120);
                        }
                        crmenus[NowRoleTab].SetActive(false);
                        NowRoleTab = CustomRoles.NotAssigned;
                        tabButton.SelectButton(true);
                        tabButton.selectedSprites.GetComponent<SpriteRenderer>().sprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Tab.TabIcon_S_{tab}.png", 120);
                ...
                CreateButton("OptionReset", Color.red, -4.55f, new Action(() =>
                {
                    ...
                    OptionItem.SyncAllOptions();
                    OptionSaver.Save();
                }), UtilsSprite.LoadSprite("TownOfHost.Resources.TOHC.RESET-STG.png", 150f));
                CreateButton("OptionCopy", Color.green, -3.9f, new Action(() =>
                {
                    ...
                    timer = 3;
                }), UtilsSprite.LoadSprite("TownOfHost.Resources.TOHC.COPY-STG.png", 180f));
                CreateButton("OptionLoad", Color.green, -3.25f, new Action(() =>
                {
                    ...
                    timer = 3;
                }), UtilsSprite.LoadSprite("TownOfHost.Resources.TOHC.LOAD-STG.png", 180f));
                ErrorNumber = 13;
        ...
        public static void CreateOptions(TabGroup tab, Dictionary<TabGroup, GameObject> menus, Dictionary<CustomRoles, GameObject> crmenus, Transform tabtransfrom, bool forceAllTabs = false)
        {
            ...
            var LabelBackgroundSprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Label.LabelBackground.png");
            var LabelBackgroundToolSprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Label.LabelBackgroundTool.png");
            var ShowOptionSprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.ShowOption.png");
            ...
            foreach (var option in OptionItem.AllOptions)
            {
                ...
                if (option.OptionBehaviour == null)
                {
                    ...
                    else
                    {
                        ...
                        if (option.IsHeader)
                        {
                            var marksprite = UtilsSprite.LoadSprite($"TownOfHost.Resources.TOHC.Label.{option.Name}.png");
