    ...
    public class GameStartManagerPatch
    {
        ...
        public static class GameStartManagerBeginGamePatch
        {
            public static bool Prefix(GameStartManager __instance)
            {
                ...
                if (DebugModeManager.Spawndummy.GetBool() && DebugModeManager.EnableTOHCDebugMode.GetBool() && GameStates.IsLocalGame && PlayerCatch.AllPlayerControls.Where(pc => pc.isDummy is false).Count() == 1
