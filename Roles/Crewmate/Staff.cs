...
public sealed class Staff : RoleBase
{
    ...
    private static void SetupOptionItem()
    {
        ...
        OptMustBeAliveToWin = BooleanOptionItem.Create(RoleInfo, 13, OptionName.StaffMustBeAliveToWin, true, false);
    ...
    {
        var winnerTeam = CustomWinnerHolder.WinnerTeam;
