...
namespace TownOfHost
{
    ...
    public class Main : BasePlugin
    {
        ...
        public const string BepInExPluginVersion = "1.43.92+15";
        public const string PluginVersion = "1.43.92.15";//ほんとはx.y.z表記にしたかったけどx.y.z.km.ks表記だと警告だされる
        public const string PluginShowVersion = "1.43.92.15";
        public const string ModVersion = ".92.15";//リリースver用バージョン変更dc9b79
