...
namespace TownOfHost
{
    ...
    public class Main : BasePlugin
    {
        ...
        public const string BepInExPluginVersion = "1.43.91+14";
        public const string PluginVersion = "1.43.91.14";//ほんとはx.y.z表記にしたかったけどx.y.z.km.ks表記だと警告だされる
        public const string PluginShowVersion = "1.43.91.14";
        public const string ModVersion = ".91.14";//リリースver用バージョン変更dc9b79
